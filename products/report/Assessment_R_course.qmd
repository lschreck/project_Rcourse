...
We wanted to study if PSA values differ by tumor stage.
...
We changed the variable class of tumor stage to a factor.
...
We visualized the continuous variables with box plots.
...
We perform a Wilcoxon rank sum test to compare the PSA levels in both tumor stages groups.
